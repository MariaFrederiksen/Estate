report 50044 "SVA Trial Balance/Budget"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SVATrialBalanceBudget.rdlc';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            RequestFilterFields = "No.", "Account Type", "Date Filter", "Budget Filter", "Global Dimension 1 Filter";
            ...
            column(GlobalDimension1Text; GlobalDimension1Text)
            {
            }
            ...
            begin
                ...
                if ("G/L Account"."Net Change" + "G/L Account"."Budgeted Amount" + GLAcc2."Budget at Date" = 0) and ("G/L Account"."Account Type" = "G/L Account"."Account Type"::Posting) then
                    CurrReport.Skip();
            end;
            ...
            begin
                ...
                EndDate := CalcDate('<1y-1D>', AccountingPeriod."Starting Date");
    ...
    begin
        ...
        GlobalDimension1Text := "G/L Account".GetFilter("Global Dimension 1 Filter");
        GLBudgetFilter := "G/L Account".GetFilter("Budget Filter");

        if GlobalDimension1Text <> '' then
            GeneralLedgerSetup.Get();
        if GeneralLedgerSetup."Global Dimension 1 Code" <> '' then begin
            Dimension.Reset();
            Dimension.SetRange("Dimension Code", GeneralLedgerSetup."Global Dimension 1 Code");
            Dimension.SetRange(Code, GlobalDimension1Text);
            if Dimension.FindFirst() then
                GLobalDimension1Text := 'Afdeling: ' + GlobalDimension1Text + ', ' + Dimension.Name;
        end;
    ...
    var
        ...
        PeriodText: Text[30];
        Text000Lbl: Label 'Period: %1', Comment = '%1 = Datefilter';
        GlobalDimension1Text: text[30];
        EndDate: Date;
        DiffPct: Decimal;
