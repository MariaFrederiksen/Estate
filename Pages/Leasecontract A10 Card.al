page 50038 "SVA Leasecontract_A10"
//Tooltip created
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Paragraf 4")
            {
                ...
                {
                    ApplicationArea = all;
                    Tooltip = 'Duedate for deposit, prepaid rent and others.';
                }
                field(TypeA9_4_DueDateFirstMonth; Rec.TypeA9_4_DueDateFirstMonth)
                {
                    ApplicationArea = all;
                    Tooltip = 'Duedate for first month rent.';
                }
            }
            group("Paragraf 5")
            {
            ...
            action(LeaseContract)
            {
                ...
                begin
                    ...
                    IF SVALeaseContractA9.FindFirst() THEN begin
                        CLEAR(RepSVAContractTypeA10);
                        RepSVAContractTypeA10.SETTABLEVIEW(SVALeaseContractA9);
                        RepSVAContractTypeA10.RunModal();
                    END;
                end;
            }
    ...
    var
        ...
        RepSVAContractTypeA10: Report "SVA ContractTypeA10";
}
